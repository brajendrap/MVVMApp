package com.tcs.vehicle.domain.usecase.getcars

import com.tcs.vehicle.domain.util.CarOrder
import com.tcs.vehicle.domain.util.OrderType
import com.tcs.data.common.Resource
